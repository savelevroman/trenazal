...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 23 2024 г., 12:55
...
(1, 'Краснов Андрей Глебович'),
(2, 'Краснов Александр Альбертович'),
(3, 'Ковалев Григорий Иванович'),
(4, 'Глущенко Ульяна Петровна'),
(5, 'Тимофеев Валерий Ильич'),
(6, 'Костеева Полина Николаевна'),
(7, 'Гройман Дарья Александровна');
...
CREATE TABLE `zapis` (
  ...
  `id_user` int(11) NOT NULL,
  `id_client` int(11) NOT NULL,
  `uslugi_number` int(11) DEFAULT '1',
...
INSERT INTO `zapis` (`id_zapis`, `id_uslugi`, `id_user`, `id_client`, `uslugi_number`, `vremya_zapis`) VALUES
(1, 1, 3, 1, 3, '2024-09-01 12:00:00'),
(2, 3, 3, 1, 1, '2024-09-01 14:00:00'),
(3, 4, 3, 1, 3, '2024-09-19 17:00:00'),
(4, 4, 3, 1, 1, '2024-09-15 17:00:00'),
(5, 4, 3, 1, 1, '2024-09-11 17:00:00'),
(6, 3, 3, 6, 2, '2024-09-20 15:00:00'),
(7, 4, 4, 1, 1, '2024-09-12 13:00:00'),
(8, 3, 4, 3, 5, '2024-09-12 18:00:00'),
(9, 1, 3, 2, 1, '2024-09-07 13:00:00'),
(10, 4, 3, 4, 10, '2024-09-04 18:00:00'),
(11, 2, 4, 3, 1, '2024-09-06 13:00:00'),
(12, 3, 4, 5, 4, '2024-09-03 18:00:00');
